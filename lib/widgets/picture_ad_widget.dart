...
class PictureAdWidget extends StatefulWidget {
  String uploaderName;
  ...
  @override
  State<PictureAdWidget> createState() => _PictureAdWidgetState();
}

class _PictureAdWidgetState extends State<PictureAdWidget> {
  @override
